            ...
            <div class="col-lg-4 col-md-6">
                <div class="artPost">
                    <div class="postHeader">
                        <div class="username">
                            <div class="image" style="width: 43px; height: 44px;"><a href="/profile_details/{{$artwork->saved_artwork->artist->id}}"><img src="{{$artwork->saved_artwork->artist->media_url}}" alt=""></a></div>
