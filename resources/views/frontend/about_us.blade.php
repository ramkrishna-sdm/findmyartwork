...
<!-- Page Header Title -->
         ...
         <div class="page-title">
            <div class="page-title-inner">
               ...
               <img src="assets/images/about-graphic.svg" class="title-img" alt="">
            </div>
         </div>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4">
                     <div class="teamMember">
                        <div class="image"><img src="assets/images/member1.jpg" class="img-fluid" alt=""></div>
                        <div class="text"><span class="memberName">Jamie Carter</span> <span class="type">oil painter</span></div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4">
                     <div class="teamMember">
                        <div class="image"><img src="assets/images/member2.jpg" alt=""></div>
                        <div class="text"><span class="memberName">Jamie Carter</span> <span class="type">oil painter</span></div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4">
                     <div class="teamMember">
                        <div class="image"><img src="assets/images/member3.jpg" alt=""></div>
                        <div class="text"><span class="memberName">Jamie Carter</span> <span class="type">oil painter</span></div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4">
                     <div class="teamMember">
                        <div class="image"><img src="assets/images/member1.jpg" alt=""></div>
                        <div class="text"><span class="memberName">Jamie Carter</span> <span class="type">oil painter</span></div>
                     </div>
                  </div>
                  <div class="col-md-4 col-sm-4">
