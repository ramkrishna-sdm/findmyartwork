                        ...
                        <div class="postFooter">
                           ...
                           <div class="rightBlock">
                              ...
                              <div class="actionIcons">
                                 <a href="javascript:void(0);"><img src="{{asset('assets/images/like.png')}}" alt=""></a>
                                 <a href="javascript:void(0);"><img src="{{asset('assets/images/dislike.png')}}" alt=""></a>
                                 <a href="javascript:void(0);"><img src="{{asset('assets/images/saved.png')}}" alt=""></a>
                              </div>
                           </div>
                        </div>
                     </div>
