                  ...
                  <div class="col-12 categorySection">
                     ...
                     <div class="d-flex justify-content-between cat-sub">
                        ...
                        <div class="form-group">
                           ...
                           <input  type="text" name=" postal_code" placeholder="Zip / Postal code" class="form-control" value="{{$artist->postal_code}}">
                      ...
                      <div class="d-flex justify-content-between cat-sub">
                        <div class="form-group">
                           ...
                           <input type="text" name="state" placeholder="State" class="form-control" value="{{$artist->state}}">
                        </div>
                        <div class="form-group">
