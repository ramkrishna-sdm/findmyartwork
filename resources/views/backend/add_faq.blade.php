                            ...
                            <form method="post" action="{{ url('/admin/update_faq') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('ans') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="ans" id="ans" class="form-control form-control-alternative{{ $errors->has('ans') ? ' is-invalid' : '' }}" placeholder="{{ __('Answer') }}" value="{{ old('ans') }}" required autofocus>
