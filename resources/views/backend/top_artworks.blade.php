                                        ...
                                        <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a href="{{url('/admin/change_artwork_status')}}/{{$artwork->id}}/{{$artwork->is_publised}}/top_artwork/{{$artwork->gallery_user_id}}" class="btn btn-danger btn-link btn-sm change_artwork_status" title="@if($artwork->is_publised == 'publish') Click to Un-Publish @else Click to Publish @endif"><i class="fa fa-power-off"></i></a>
