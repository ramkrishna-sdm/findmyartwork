...
class AboutUsController extends Controller
{
    ...
    */
    public function __construct(Request $request, AboutUsRepository $AboutUsRepository)
    {
    ...
    */
    public function update_aboutus(Request $request) {
    	...
    	$second_img_url = $this->request->file('second_img_url');
            ...
            $upload_file = $this->AboutUsRepository->createUpdateData(['id'=> $this->request->id],$aboutus_array);
    ...
    */
    public function update_cms(Request $request) {
        ...
        try{
            ...
            $cms = $this->AboutUsRepository->createUpdateData(['id'=> $request->id],$request->all());
